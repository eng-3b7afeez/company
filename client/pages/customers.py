...
class Customers(ttk.Frame):
    ...
    def initialize_table(self):
        ...
        row_data = []
        try:
            row_data = [customer.values() for customer in self.customers]
    ...
    def add_customer(self):
        ...
        add_customer_form = CustomerCreateForm(
            self, api=self.api
        )
        add_customer_form.pack(fill="both", expand=True, padx=10, pady=10)
    ...
    def update_customer(self, _):
        ...
        self.table.pack_forget()
        self.buttons_frame.pack_forget()
        update_customer_form = CustomerUpdateForm(self, api=self.api, customer=customer)
        update_customer_form.pack(fill="both", expand=True, padx=10, pady=10)
